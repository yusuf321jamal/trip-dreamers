  ...
  return (
    <section id="enquiry" className="scroll-mt-24 bg-white py-16 sm:py-20">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2">
        <Reveal variants={slideInLeft} className="overflow-hidden rounded-3xl shadow-card">
          <img
          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              <motion.div
                ...
                className="mt-8 flex flex-col items-start rounded-2xl bg-mint-50 p-6"
              >
              ...
              >
                ...
                <motion.button
                  {...tapHover}
                  type="submit"
                  className="bg-gradient-brand col-span-full mt-1 rounded-xl py-3.5 text-sm font-bold text-white shadow-card"
                >
                  Plan My Trip
                </motion.button>
              </motion.form>
